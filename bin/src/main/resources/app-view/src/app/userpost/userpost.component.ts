...
export class UserpostComponent implements OnInit {
  ...
  constructor(
    ...
    private storage: StorageService, private postsService: PostsService, private userService: UserService, private newpostService: NewpostService, private friendService: FriendService
  ) { }
