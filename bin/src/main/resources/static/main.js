...
/* harmony import */ var _otheruserprofile_otheruserprofile_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./otheruserprofile/otheruserprofile.component */ "./src/app/otheruserprofile/otheruserprofile.component.ts");
...
var routes = [
    ...
    { path: "login", component: _welcomeview_welcomeview_component__WEBPACK_IMPORTED_MODULE_5__["WelcomeviewComponent"] },
    { path: "login/:userid/:vtoken", component: _registered_registered_component__WEBPACK_IMPORTED_MODULE_10__["RegisteredComponent"] },
    ...
    { path: "home", component: _mainview_mainview_component__WEBPACK_IMPORTED_MODULE_3__["MainviewComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
    ...
    { path: 'otheruserprofile', component: _otheruserprofile_otheruserprofile_component__WEBPACK_IMPORTED_MODULE_14__["OtheruserprofileComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] }
];
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.newUserModel = new _users__WEBPACK_IMPORTED_MODULE_2__["Users"](null, null, null, false);
...
var MessagesthreadComponent = /** @class */ (function () {
    ...
    MessagesthreadComponent.prototype.loadMessages = function () {
        ...
        for (var _i = 0, _a = this.messages; _i < _a.length; _i++) {
            var i = _a[_i];
            if (i.userid1 === this.userid) {
                if (this.storage.getMessageThreadUser() === (i.user2.email)) {
                ...
                if (this.storage.getMessageThreadUser() === (i.user1.email)) {
                    this.newSpecificMessage = i.user1.email + ": " + i.textcontents;
                    this.newSpecificMessages.push(this.newSpecificMessage);
                    this.storage.setUserId2(i.user1.id);
                    this.storage.setUser1(i.user2);
                    this.storage.setUser2(i.user1);
...
var RegisteredComponent = /** @class */ (function () {
    function RegisteredComponent(router, route, http, _userService) {
        ...
        this.user = new _users__WEBPACK_IMPORTED_MODULE_6__["Users"](null, null, null, false);
    }
...
var UpdateprofileComponent = /** @class */ (function () {
    ...
    UpdateprofileComponent.prototype.ngOnInit = function () {
        this.userModel = new _users__WEBPACK_IMPORTED_MODULE_2__["Users"](Number(localStorage.getItem('token')), localStorage.getItem('username'), null, true);
            ...
            if (dataIsValid == null) {
                ...
                _this._userService.updateInfo(user).subscribe(function (data) {
                    if (data == null) {
                        ...
                        user = data;
                        _this._userService.setLoggedInUserById(user.id, user);
    ...
    UpdateprofileComponent.prototype.resetFields = function () {
        this.f.password.setValue('');
        this.f.confirmPassword.setValue('');
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.updateInfo = function (user) {
        console.log('updating information: ' + JSON.stringify(user));
        return this.http.post(this._url.concat('updateInfo'), JSON.stringify(user), httpPostOptions);
    };
    ...
    UserService.prototype.setLoggedInUserById = function (id, user) {
...
var UserpostService = /** @class */ (function () {
    ...
    UserpostService.prototype.getPostsById = function (userId) {
        return this.http.post(this.userposts, userId, httpOptions);
    };
...
var Users = /** @class */ (function () {
    function Users(id, email, password, enabled) {
        this.id = id;
        this.email = email;
...
module.exports = __webpack_require__(/*! C:\Users\christian\java\reactive\src\main\resources\app-view\src\main.ts */"./src/main.ts");
